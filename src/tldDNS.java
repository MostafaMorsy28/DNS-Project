...
public class tldDNS {
    public static void main(String[] args) throws IOException {
        try {
            ...
            tldDNS.threading clientConnection = new tldDNS.threading(serverSocket);
            clientConnection.start();
        } catch (IOException ex) {
            Logger.getLogger(tldDNS.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    /*/*Searching file****/
                    File dns1 = new File("C:\\Users\\David\\Desktop\\DNSProject\\src\\TLD_dns_table.txt");
