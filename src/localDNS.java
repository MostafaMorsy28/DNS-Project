...
public class localDNS {
    public static void main(String[] args) throws IOException {
        try {
            ...
            System.out.println("DNS_Server is connected");
            localDNS.threading clientConnection = new localDNS.threading(serverSocket);
            clientConnection.start();
        } catch (IOException ex) {
            Logger.getLogger(localDNS.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    /*/*Searching file****/
                    File dns1 = new File("C:\\Users\\David\\Desktop\\DNSProject\\src\\local_dns_table.txt");
